                                                ...
                                                <div class="card-body">           
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="custom-select" name="urgence" id="urg_select">
                                                                <option selected>Sélectionner un niveau d'urgence</option>
                                                                <option value="1">Basse</option>
                                                                <option value="2">Moyen</option>
                                                                <option value="4">Urgente</option>
                                                                <option value="5">Très urgente</option>
                                                                <option value="6">Bloquante</option>
                                                            </select>
                                                        </div>
                                                    </div> 
                                                     <div class="form-group row">
                                                    ...
                                                    <div>
                                                        <div class="text-center m-t-15">
                                                            <button class="btn btn-primary waves-effect waves-light" id="dem_butt" type="submit">Envoyer</button>
                                                        </div>
                                                    </div>  
                                                </div>
                                            </div>
